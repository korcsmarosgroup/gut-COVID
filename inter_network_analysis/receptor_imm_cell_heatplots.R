...
#lr_sep_inf<- read.csv("results/triana_2020/ligand_receptor_ints/3rd_set_imm_cells/ileum/infected/stats2_ligand_receptor_ints_triana_ileum_infec_martin_si_uninfl.txt", sep = "\t")
#lr_sep_by <- read.csv("results/triana_2020/ligand_receptor_ints/3rd_set_imm_cells/ileum/bystander/stats2_ligand_receptor_ints_triana_ileum_bystand_martin_si_uninfl.txt", sep = "\t")
lr_sep_inf <- read.csv("results/triana_2020/ligand_receptor_ints/3rd_set_imm_cells/colon/infected/stats2_ligand_receptor_ints_triana_colon_infec_smillie_colon_health.txt", sep = "\t")
lr_sep_by <- read.csv("results/triana_2020/ligand_receptor_ints/3rd_set_imm_cells/colon/bystander/stats2_ligand_receptor_ints_triana_colon_bystand_smillie_colon_health.txt", sep = "\t")

# Outfile for the normal heatplot
#out_f_inf <- "results/triana_2020/ligand_receptor_ints/3rd_set_imm_cells/ileum/infected/plots/receptors_v_immcells_10032021/"
#out_f_by <- "results/triana_2020/ligand_receptor_ints/3rd_set_imm_cells/ileum/bystander/plots/receptors_v_immcells_10032021/"
out_f_inf <- "results/triana_2020/ligand_receptor_ints/3rd_set_imm_cells/colon/infected/plots/receptors_v_immcells_10032021/"
out_f_by <- "results/triana_2020/ligand_receptor_ints/3rd_set_imm_cells/colon/bystander/plots/receptors_v_immcells_10032021/"

# Outfile for the smaller heatplot
#out_f_inf2 <- "results/triana_2020/ligand_receptor_ints/3rd_set_imm_cells/ileum/infected/plots/receptors_v_immcells_10032021/less_5_cells/"
#out_f_by2 <- "results/triana_2020/ligand_receptor_ints/3rd_set_imm_cells/ileum/bystander/plots/receptors_v_immcells_10032021/less_5_cells/"
out_f_inf2 <- "results/triana_2020/ligand_receptor_ints/3rd_set_imm_cells/colon/infected/plots/receptors_v_immcells_10032021/less_5_cells/"
out_f_by2 <- "results/triana_2020/ligand_receptor_ints/3rd_set_imm_cells/colon/bystander/plots/receptors_v_immcells_10032021/less_5_cells/"
...
hplot <- function(indata2, out_f){
  ...
  for (name1 in names(indata_spl)){
    ...
    for (table2 in table_spl){
      ...
      # Create output filepath
      out_p <- paste0(out_f, "colon_heatplot_receptor_vs_immcell_", table2$ligand_cell_source[1], "_", name1, ".png")
