...
lr_sep_inf<- read.csv("results/ligand_receptor_ints/3rd_set_imm_cells/ileum/infected/stats2_ligand_receptor_ints_triana_ileum_infec_martin_si_uninfl.txt", sep = "\t")
lr_sep_by <- read.csv("results/ligand_receptor_ints/3rd_set_imm_cells/ileum/bystander/stats2_ligand_receptor_ints_triana_ileum_bystand_martin_si_uninfl.txt", sep = "\t")
#lr_sep_inf<- read.csv("results/ligand_receptor_ints/3rd_set_imm_cells/colon/infected/stats2_ligand_receptor_ints_triana_colon_infec_smillie_colon_health.txt", sep = "\t")
#lr_sep_by <- read.csv("results/ligand_receptor_ints/3rd_set_imm_cells/colon/bystander/stats2_ligand_receptor_ints_triana_colon_bystand_smillie_colon_health.txt", sep = "\t")

# Outfile for the normal heatplot
out_f_inf <- "results/ligand_receptor_ints/3rd_set_imm_cells/ileum/infected/plots/num_imm_cells/"
out_f_by <- "results/ligand_receptor_ints/3rd_set_imm_cells/ileum/bystander/plots/num_imm_cells/"
#out_f_inf <- "results/ligand_receptor_ints/3rd_set_imm_cells/colon/infected/plots/num_imm_cells/"
#out_f_by <- "results/ligand_receptor_ints/3rd_set_imm_cells/colon/bystander/plots/num_imm_cells/"
...
hplot <- function(indata, out_f){
  ...
  for (name1 in names(indata_spl)){
    ...
    out_p <- paste0(out_f, "facet_ileum_heatplot_num_cells_", name1, ".png")
