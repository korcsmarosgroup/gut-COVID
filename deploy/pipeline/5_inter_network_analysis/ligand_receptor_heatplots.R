...
message("\nStarting differential expression analysis script: ligand_receptor_heatplots.R\n")
...
hplot <- function(indata, out_f){
  ...
  for (name1 in names(indata_spl)){
    ...
    for (table2 in table_spl){
      ...
      # Create output filepath
      out_p <- paste0(out_f, "heatplot_num_cells_", table2$ligand_cell_source[1], "_", name1, ".png")
