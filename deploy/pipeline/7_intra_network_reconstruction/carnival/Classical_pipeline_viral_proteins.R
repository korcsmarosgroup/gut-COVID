...
all_genes_dea <- read.csv("input_files/expression_data/unfilt_degs_colon_24h_infected_enterocytes_vs_mock.csv", sep = ",")
...
host_viral_interactions <- 
  read.csv("input_files/sarscov2-human_viral_ppis.txt", sep = "\t")
