...
message("\nStarting differential expression analysis script: ligand_receptor_stats.R\n")
...
#lr_ints <- read.csv("results/triana_2020/ligand_receptor_ints/3rd_set_imm_cells/ileum/infected/ligand_receptor_ints_triana_ileum_infec_martin_si_uninfl.txt", sep = "\t")
#lr_ints <- read.csv("results/triana_2020/ligand_receptor_ints/3rd_set_imm_cells/colon/infected/ligand_receptor_ints_triana_colon_infec_smillie_colon_health.txt", sep = "\t")
#lr_ints <- read.csv("results/triana_2020/ligand_receptor_ints/3rd_set_imm_cells/colon/bystander/ligand_receptor_ints_triana_colon_bystand_smillie_colon_health.txt", sep = "\t")
#lr_ints <- read.csv("results/triana_2020/ligand_receptor_ints/3rd_set_imm_cells/ileum/bystander/ligand_receptor_ints_triana_ileum_bystand_martin_si_uninfl.txt", sep = "\t")

# Outfiles
out_tog <- args[2]
out_sep <- args[3]
out_lr <-  args[4]
# out_tog <- "results/triana_2020/ligand_receptor_ints/3rd_set_imm_cells/colon/bystander/stats_tog_ligand_receptor_ints_triana_colon_bystand_smillie_colon_health.txt"
# out_sep <- "results/triana_2020/ligand_receptor_ints/3rd_set_imm_cells/colon/bystander/stats_sep_ligand_receptor_ints_triana_colon_bystand_smillie_colon_health.txt"
# out_lr <-  "results/triana_2020/ligand_receptor_ints/3rd_set_imm_cells/colon/bystander/stats2_ligand_receptor_ints_triana_colon_bystand_smillie_colon_health.txt"
