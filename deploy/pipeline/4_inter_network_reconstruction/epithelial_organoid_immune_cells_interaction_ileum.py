...
if os.path.isfile('epithelial_organoid_immune_cells_interaction_ileum.log'):
    os.remove("epithelial_organoid_immune_cells_interaction_ileum.log")

logging.basicConfig(filename = 'epithelial_organoid_immune_cells_interaction_ileum.log', format = '%(asctime)s :: %(levelname)s :: %(funcName)s :: %(lineno)d :: %(message)s', level = logging.INFO)
...
logging.info("epithelial_organoid_immune_cells_interaction_ileum.py is starting")
...
df_epi_deg = pd.read_csv(df_epi_deg_file, index_col=5, sep="\t")
...
logging.info("Set up epithelial cell DEGs")
...
logging.info("epithelial_organoid_immune_cells_interaction_ileum.py is successfully finished!")
