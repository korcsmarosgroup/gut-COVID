...
message("\nStarting differential expression analysis script: Classical_pipeline_viral_miRNAs.R\n")
...
signed_directed_interactions <- 
  ...
  dplyr::mutate(interaction = if_else(consensus_stimulation==1,1,-1))  %>%
  dplyr::select(source_genesymbol, interaction,  target_genesymbol) %>%
...
carnival_results_top50tf_pleitropic_minsize15 <-runCARNIVAL(
  solverPath="/opt/ibm/ILOG/CPLEX_Enterprise_Server1210/CPLEX_Studio/cplex/bin/x86-64_linux/cplex",
  netObj=carnival_pkn_hostvirus,
  measObj=tf_top50_pleitropic,
  inputObj = viral_proteins_perturbation,
  #dir_name="3_intra_network_reconstruction/carnival",
...
#         file = "/home/gutcovid/8_intra_output_data/carnival/carnival_mirnas_results_top50tf_pleitropic_minsize15_activation.rds")
# OutputCyto(carnival_results_top50tf_pleitropic_minsize15_activation, 
#            outputFile="/home/gutcovid/8_intra_output_data/carnival/carnival_mirnas_results_top50tf_pleitropic_minsize15_activation.cys")
...
#         file = "/home/gutcovid/8_intra_output_data/carnival/colon_carnival_mirnas_results_top50tf_pleitropic_minsize15_undefinedEffect.rds")
# OutputCyto(carnival_results_top50tf_pleitropic_minsize15_undefinedEffect, 
#            outputFile="/home/gutcovid/8_intra_output_data/carnival/colon_carnival_mirnas_results_top50tf_pleitropic_minsize15_undefinedEffect.cys")
