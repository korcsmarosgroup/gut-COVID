...
lr_sep_inf <- read.csv("stats2_ligand_receptor_ints_lung_ciliated_immune_cells.txt", sep = "\t")
#lr_sep_by <- read.csv("3_inter_network_reconstruction/stats2_ligand_receptor_ints_lung_squamousous_immune_cells.txt", sep = "\t")
...
#out_f_inf2 <- "outputs/5cells"
#out_f_by2 <- "outputs/5cells"
