...
scripts_folders = {
    ...
    "5_betweenness_and_cluster_analysis": ["cytoscape_visualisation.R"]
}
scripts_parameters = {
    ...
    "get_regulator_deg_network.R": ["2_process_a_priori_networks/dorothea_contextualised_network.txt",
                                    "1_process_expression_data/filt_degs_ileum_24h_infected_enterocytes_vs_mock_padj0.05_lfc0.5.csv",
                                    "id_type",
                                    "outdir"],
    ...
    "combined_edge_node_tables.R": ["3_network_diffusion/TieDIE/tiedie.cn.sif",
                                    ...
                                    "sars",
                                    "2_process_a_priori_networks/contextualised_regulator-deg_network.txt",
                                    "1_process_expression_data/unfilt_degs_ileum_24h_infected_enterocytes_vs_mock.csv",
                                    "id_type",
                                    "outdir"],
