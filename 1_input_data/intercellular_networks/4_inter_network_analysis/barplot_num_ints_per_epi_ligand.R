...
# Input files
#in_file <- read.csv("triana_2020/ligand_receptor_ints/3rd_set_imm_cells/ileum/infected/ligand_receptor_ints_triana_ileum_infec_martin_si_uninfl.txt", sep = "\t")
#in_file <- read.csv("triana_2020/ligand_receptor_ints/3rd_set_imm_cells/ileum/bystander/ligand_receptor_ints_triana_ileum_bystand_martin_si_uninfl.txt", sep = "\t")
#in_file <- read.csv("triana_2020/ligand_receptor_ints/3rd_set_imm_cells/colon/bystander/ligand_receptor_ints_triana_colon_bystand_smillie_colon_health.txt", sep = "\t")
in_file <- read.csv("triana_2020/ligand_receptor_ints/3rd_set_imm_cells/colon/infected/ligand_receptor_ints_triana_colon_infec_smillie_colon_health.txt", sep = "\t")

# Outfile
#plot_out <- "triana_2020/ligand_receptor_ints/3rd_set_imm_cells/ileum/infected/plots/ligands"
#plot_out <- "triana_2020/ligand_receptor_ints/3rd_set_imm_cells/ileum/bystander/plots/ligands"
#plot_out <- "triana_2020/ligand_receptor_ints/3rd_set_imm_cells/colon/bystander/plots/ligands"
plot_out <- "triana_2020/ligand_receptor_ints/3rd_set_imm_cells/colon/infected/plots/ligands"
...
# Save
ggsave(plot_ligs, file=file.path(plot_out,"num_ints_per_ligand_12072021.png"),width = 9, height=5)
...
for (cell in cell_types) {
  ...
  # Save
  ggsave(plot_ligs2, file=file.path(plot_out, paste0("num_ints_per_ligand_",cell, "_12072021.png")),width = 5, height=2.5)
